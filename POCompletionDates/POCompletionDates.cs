...
namespace MoonStation
{
    public partial class POCompletionDates : MaterialForm
    {
        ...
        private void UpLoad(DataTable tab)
        {
            ...
            d.Add("data", tab);
            string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.client.APIURL, "KZ_SFCAPI", "KZ_SFCAPI.Controllers.POCompletionDates", "UpLoad",
        ...
        private void butquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.client.APIURL, "KZ_SFCAPI", "KZ_SFCAPI.Controllers.POCompletionDates", "Query", Program.client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
