    ...
    public partial class MainForm : MaterialForm
    {
        ...
        private void GetDepartmentByUser() {
            ...
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                //tier 2 - section
                var tmp = !string.IsNullOrEmpty(dtJson.Rows[0]["UDF07"].ToString()) ? dtJson.Rows[0]["UDF07"].ToString() : dtJson.Rows[0]["STAFF_DEPARTMENT"].ToString();
        ...
        private void lblEfficiencyHeader_Click(object sender, EventArgs e)
        {
            ...
            MethodInfo method = type.GetMethod("RunCustomizeWithDept");
        ...
        private void LoadDeliveryChart()
        {
            ...
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                chartDelivery.Titles.Add("The status of PO achievement in the past 7 days of production");
        ...
        private void LoadMainBarChart()
        {
            ...
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                chartMainBar.Titles.Add("Improve the total no.of Reports: " + temp.ToString());
        ...
        private void chartQuality_Click(object sender, EventArgs e)
        {
        ...
        {
            POComRateForm poComRateForm = new POComRateForm(dept,currentDate,"2");
            poComRateForm.Show(); 
