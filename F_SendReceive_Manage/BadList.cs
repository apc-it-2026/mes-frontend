...
namespace F_SendReceive_Manage
{
    public partial class BadList : Form
    {
        ...
        public BadList(string sample)
        {
            ...
            string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.client.APIURL, "KZ_MESAPI", "KZ_MESAPI.Controllers.SCM_Sample_ReceiveService", "QueryNGList", Program.client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(dictionary));
