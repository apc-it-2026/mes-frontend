    ...
    public partial class TMS_AttendanceRecord : MaterialForm
    {
        ...
        private void LoadDepartment()
        {
            ...
            if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                //org
                cbbDepartmentRecord.DataSource = dt;
                cbbDepartmentRecord.ValueMember = "DEPARTMENT_CODE";
                //layout
                cbbDepartmentSummary.DataSource = dt;
                cbbDepartmentSummary.ValueMember = "DEPARTMENT_CODE";
                //Attendance
            ...
            if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                if (dt.Rows.Count > 0) {
                    ...
                    while (i >= 0) {
                        ...
                        {
                            cbbDepartmentRecord.SelectedIndex = cbbDepartmentRecord.FindString(dt.Rows[0][i].ToString());
                            cbbDepartmentSummary.SelectedIndex = cbbDepartmentSummary.FindString(dt.Rows[0][i].ToString());
        ...
        private void LoadRecord() {
            ...
            //p.Add("G_DEPARTMENT", cbbDepartmentRecord.SelectedValue.ToString());
            p.Add("G_DEPARTMENT", cbbDepartmentRecord.Text);
            string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(
        ...
        private void LoadSummary()
        {
            ...
            p.Add("G_DEPARTMENT", cbbDepartmentSummary.Text);
