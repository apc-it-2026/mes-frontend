...
using static F_Work_SendReceive_Manage.BadList;
...
namespace F_Work_SendReceive_Manage
{
    public partial class Delay_Registration : MaterialForm
    {
        ...
        DataTable StationDataTable;
        DataTable CausesDataTable;
        ...
        public void DataChanged_DataGridRow(object sender, DataChangeEventArgsItem args)
        {
            ...
            string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.client.APIURL, "KZ_MESAPI", "KZ_MESAPI.Controllers.SCM_Work_ReceiveService", "QuerySizeNo", Program.client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(dictionary));
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.client.APIURL, "KZ_MESAPI", "KZ_MESAPI.Controllers.SCM_Work_ReceiveService", "InsertABNLMD", Program.client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(dictionary));
            if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                string retData = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
