...
namespace MonthlyManPowerUpload
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            client.UserToken = "37645485-8c4c-4d8f-bb83-ea428f2d042e"; //real library 67143
            //client.UserToken = "988b291d-9840-40a6-a007-df4616abb388"; //test library 67143
            client.Language = "en";
            Application.Run(new MonthlyManPowerUpload());
            //Application.Run(new MonthlyExcessManPowerUpload());
        }
