...
{
    public partial class ProductionWorkingHours_TransHours : MaterialForm
    {
        ...
        public ProductionWorkingHours_TransHours()
        {
            InitializeComponent();
        ...
        public ProductionWorkingHours_TransHours(string department_code, string department_name, string work_day,string rout_no)
        {
            InitializeComponent();
        ...
        private void TransForm_Load(object sender, EventArgs e)
        {
            ...
            this.txt_work_day.Text = work_day;
            this.txtMoveDate.Text = DateTime.Now.ToShortDateString();
            LoadMoveNo();
            LoadSeDept();
        }
