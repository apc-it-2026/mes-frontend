...
namespace TierMeeting
{
    public partial class MainForm : MaterialForm
    {
        ...
        {
            MaturityAssessmentForm frm = new MaturityAssessmentForm("C", type);
            frm.Show();
        }
        ...
        private void lblEfficiencyHeader_Click(object sender, EventArgs e)
        {
            ...
            Fourth_EfficiencyForm efficiencyForm = new Fourth_EfficiencyForm("" , currentDate.ToShortDateString());
        ...
        private void GetDeliveryData()
        {
            ...
            if (range != null)
            {
                ...
                {
                    //SetBackColor(txtSDP, Color.Orange);
                    if (r.Column == tempCol)
                    {
            ...
            if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                SetText(txtPOCompletionRate, "100%");
                ...
                chartDelivery.Series[0].ToolTip = "#VALY";
                chartDelivery.ChartAreas[0].AxisX.MajorGrid.Enabled = false;
                chartDelivery.ChartAreas[0].AxisY.MajorGrid.Enabled = false;
            }
        }
                ...
                foreach (DataRow r in dtJson.Rows)
                {
                    ...
                    if (r["MANPOWER"] != null) {
                        if (!(string.IsNullOrEmpty(r["MANPOWER"].ToString()) || r["MANPOWER"].ToString() == "0")) {
                            ...
                            tempPPH = Math.Round(r["QTY"].ToDouble() / r["MANPOWER"].ToDouble(), 2);
                            //if (!string.IsNullOrEmpty(r["MANPOWER"].ToString()))//
        ...
        private void LoadMainBarChart()
        {
            ...
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                chartMainBar.Titles.Add("改善快报个数");
                chartMainBar.Series[0].ChartType = SeriesChartType.Bar;
        ...
        {
            POComRateForm poComRateForm = new POComRateForm(dept, currentDate, "4");
            poComRateForm.Show();
