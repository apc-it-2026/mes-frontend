...
namespace TierMeeting
{
    public partial class Tier3DeliveryForm : MaterialForm
    {
        ...
        {
			dateTimePicker3.Text = this.date;
			this.GetData(this.dateTimePicker3.Text);
		...
		private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (flag)
			{
				Tier2DeliveryForm frm = new Tier2DeliveryForm(this.dateTimePicker3.Text, this.dataGridView1.Rows[index].Cells["code"].Value.ToString());
				frm.Show();
			}
		}
	}
