...
{
    public partial class F_Bad_Registration : MaterialForm
    {
        public F_Bad_Registration()
        {
            InitializeComponent();
        }
        ...
        private void SelectSampleNO()
        {
            ...
            string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "SelectSampleNO", Program.client.UserToken, JsonConvert.SerializeObject(string.Empty));
        ...
        private void LoadDatagridview2()
        {
            ...
            string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "SelectBySampleOrder", Program.client.UserToken, JsonConvert.SerializeObject(p));
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                string json = JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
        ...
        private void btnExamMore_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView2.Rows.Count > 0 && dataGridView2 != null)
            {
                foreach (DataGridViewRow row in dataGridView2.Rows)
                {
                    ...
                    {
                        if (dataGridView2.Rows[row.Index].Cells[10].Value.ToString() == "待审核")
                        {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (result == DialogResult.OK)
                    {
                        ...
                        p.Add("ng_no_dt", dt);
                        string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "ExamMore", Program.client.UserToken, JsonConvert.SerializeObject(p));
                        if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                        {
        ...
        private void SelectNgInfoBySampleNo()
        {
            ...
            string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "SelectNgInfoBySampleNo", Program.client.UserToken, JsonConvert.SerializeObject(p));
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                if (dt1.Rows.Count > 0)
                {
                    txtArtNo.Text = dt1.Rows[0]["art_no"].ToString();
                    txtShoesType.Text = dt1.Rows[0]["art_name"].ToString();
                    txtPurpose.Text = dt1.Rows[0]["purpose"].ToString();
                    txtSeason.Text = dt1.Rows[0]["season"].ToString();
                    txtMatchColor.Text = dt1.Rows[0]["color_way"].ToString();
                    txtModelMater.Text = dt1.Rows[0]["TYPE_LEADER"].ToString();//型体负责人
                    txtPatternMaster.Text = dt1.Rows[0]["SAMPLE_LEADER"].ToString();//版型负责人
                }
                else
                {
                ...
                if (dt2.Rows.Count > 0)
                {
                    txtBadOrder.Text = dt2.Rows[0]["ng_no"].ToString();
                    txtStatus.Text = GetStatus(dt2.Rows[0]["status"].ToString());
                    txtRegistratUnit.Text = dt2.Rows[0]["REGISTRATION_DEPT"].ToString();
                    rtxtReamrk.Text = dt2.Rows[0]["remark"].ToString();
                    txtRegisterUser1.Text = dt2.Rows[0]["CREATE_USER"].ToString();
                    txtRegisterDate.Text = dt2.Rows[0]["CREATE_DATE"].ToString();
                    txtModifyUser1.Text = dt2.Rows[0]["LAST_USER"].ToString();
                    txtModifyDate.Text = dt2.Rows[0]["LAST_DATE"].ToString();
                    txtRegistratDate.Text = dt2.Rows[0]["REGISTER_DATE"].ToString();
                    ...
                    {
                        btnUpdate.Enabled = btnSave.Enabled = btnExam.Enabled = btnDelete.Enabled = true;
                        btnAddNg.Enabled = btnDelNg.Enabled = false;
                    }
                ...
                else
                {
                    txtBadOrder.Text = "";
                    txtStatus.Text = "新单";
                    txtRegistratUnit.Text = "";
                    rtxtReamrk.Text = "";
                    txtRegisterUser1.Text = "";
                    txtRegisterDate.Text = "";
                    txtModifyUser1.Text = "";
                    txtModifyDate.Text = "";
                    txtRegisterUser2.Text = "";
                    txtModifyUser2.Text = "";
                        btnUpdate.Enabled = btnSave.Enabled = btnExam.Enabled = btnDelete.Enabled = btnAddNg.Enabled = btnDelNg.Enabled = true;
                }
        ...
        private void btnAddNg_Click(object sender, EventArgs e)
        {
            ...
            string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "GetSampleLogoListInfo", Program.client.UserToken, JsonConvert.SerializeObject(dic));
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                string json = JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
            ...
            else
            {
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                    ...
                    for (int i = 0; i < dataGridView1.Rows.Count; i++)
                    {
                        ...
                        if (partName == part_name && processName == process_name && suppliersName == suppliers_name && sizeNo == size_no)
                        {
        ...
        private void btnDelNg_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(result))
            {
                ...
                if (DialogResult.OK == dialogResult)
                {
                    ...
                    string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "DelNg", Program.client.UserToken, JsonConvert.SerializeObject(dic));
                    if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                btnAddNg.Enabled = btnDelNg.Enabled = true;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            p.Add("sampleOrder", txtSampleOrder.Text);
            p.Add("REGISTER_DATE", txtRegistratDate.Value.ToString("d"));
            p.Add("STATUS", status);
            ...
            string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "SaveSampleOrder", Program.client.UserToken, JsonConvert.SerializeObject(p));
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                string json = JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
                DataTable dt = JsonConvert.DeserializeObject<DataTable>(json);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == result)
            {
                ...
                string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "DelSampleOrder", Program.client.UserToken, JsonConvert.SerializeObject(p));
                if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                {
                    MessageHelper.ShowSuccess(this, "删除成功！");
                    txtStatus.Text = "已删除";
        ...
        private void btnExam_Click(object sender, EventArgs e)
        {
            if (txtStatus.Text == "待审核")
            {
                ...
                if (result == DialogResult.OK)
                {
                    Dictionary<object, object> p = new Dictionary<object, object>();
                    p.Add("badOrderNo", txtBadOrder.Text);
                    string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "ExamSampleOrder", Program.client.UserToken, JsonConvert.SerializeObject(p));
                    if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                    {
        ...
        private void LoadSampleNg(string badOrder, string sampleOrder)
        {
            ...
            string ret = WebAPIHelper.Post(Program.client.APIURL, "KZ_WOOAPI", "KZ_WOOAPI.Controllers.F_Bad_RegistrationServer", "SelectAllByBadOrder", Program.client.UserToken, JsonConvert.SerializeObject(p));
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                string json = JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
                List<DataTable> list = JsonConvert.DeserializeObject<List<DataTable>>(json);
